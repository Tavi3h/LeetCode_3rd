...
public class WordLadderII {
    public List<List<String>> findLadders(String beginWord, String endWord, List<String> wordList) {
        ...
        dfs(beginWord, endWord, neighborsMap, dist, path, res);
        return res;
    }

    private void dfs(String beginWord, String endWord, Map<String, List<String>> neighborsMap,
        ...
        if (beginWord.equals(endWord)) {
            ...
            for (String next : neighborsMap.get(beginWord)) {
                if (dist.get(next) == dist.get(beginWord) + 1) {
                    dfs(next, endWord, neighborsMap, dist, path, res);
                }
            }
        }
